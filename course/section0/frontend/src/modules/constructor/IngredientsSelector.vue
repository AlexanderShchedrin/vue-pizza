      ...
      >
        ...
        <div class="counter counter--orange ingredients__counter">
          <button
            ...
            :disabled="getValue(ingredientsData.value) === 0"
            @click="decrementValue(ingredientsData.value)"
          >
          ...
          <input
            ...
            @input="inputValue(ingredientsData.value, $event.target.value)"
          />
          <button
            type="button"
            class="counter__button counter__button--plus"
            :disabled="getValue(ingredientsData.value) === MAX_INGREDIENT_COUNT"
            @click="incrementValue(ingredientsData.value)"
          >
